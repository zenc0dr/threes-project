...
export default {
    ...
    mounted() {
        this.editor = grapesjs.init({
            ...
            canvas: {
                styles: [
                    '/modules/backend/assets/vendor/bootstrap/bootstrap.css',
                    '/modules/backend/assets/vendor/bootstrap-icons/bootstrap-icons.css',
                    '/modules/backend/assets/css/october.css',
                    '/plugins/zen/threes/assets/css/threes.css'
                ],
                scripts: [
                    '/modules/system/assets/js/vendor/jquery.min.js',
                    '/modules/backend/assets/vendor/bootstrap/bootstrap.min.js'
                ]
            }
        })
